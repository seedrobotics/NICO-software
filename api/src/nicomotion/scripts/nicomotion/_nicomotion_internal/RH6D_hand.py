...
class RH6DHand(AbstractHand):
    """This class represents the Seed Robotics RH6D Hand."""
	"""First Revision by SeedRobotics Sept 2021."""
    ...
    def __init__(self, robot, isLeft, monitorCurrents=True, vrep=False):
        super(RH6DHand, self).__init__(robot, isLeft, monitorCurrents, vrep)
